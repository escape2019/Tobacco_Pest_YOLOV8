...
def parse_opt():
    ...
    parser.add_argument('--cfg', type=str, default='hyp-pest.yaml', help='hyperparameters path')
    parser.add_argument('--data', type=str, default='/Data/zhangkai/yolov8/data.yaml', help='data yaml path')
